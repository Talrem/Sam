...
module.exports.help = {
  name: "superMarioMaker",
  type: "Private",
  usage: "superMarioMaker <nom>",
  desc: "j'envois les niveaux Super Mario Maker 2. Si le nom du créateur n'est pas donné, la commande va renvoyer toutes les requêtes."
}
