...
module.exports.run = async (bot, message, args) => {
  ...
  return message.channel.send("La plainte a été déposée avec succès. son id est : " + (cardFile[-1].number - 1)).then(msg => msg.delete(5000)).catch(error => console.log(`Impossible de supprimer le messages car ${error}`));
}
